...
│  │ ─────────────────────────────────────────────  │  │
│  │ User1's prediction (30% NDA, 20% MGB...)      │  │
│  │ User2's scenario (40% NDA, 25% MGB...)        │  │
│  │ User3's analysis (20% NDA, 10% MGB...)         │  │
│  └───────────────────────────────────────────────┘  │
...
- If 3 predictions exist:
  - User1: 30% NDA, 20% MGB, 50% Others
  - User2: 40% NDA, 30% MGB, 60% Others
  - User3: 20% NDA, 10% MGB, 40% Others
